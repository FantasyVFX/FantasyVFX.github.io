var footlogo =
    '<span style="vertical-align: top;display: inline-block;">&nbsp;&nbsp;&nbsp;&nbsp;技术支持</span> <a id="flogo" target="_blank" href="http://www.uemo.net/"><img src="2/logo/logo.png"/*tpa=http://resources.jsmo.xin/templates/upload/2/logo/logo.png*/ width="50" height="20"></a>';

if (window.location.origin.indexOf("http://resources.jsmo.xin/templates/upload/uemo.net") != -1 && !$("#flogo")[0]) {
...
if (window.location.origin.indexOf("http://resources.jsmo.xin/templates/upload/jsmo.xin") != -1) {
